                    ...
                    <div className="max-w-7xl mx-auto">
                        {navItems.map(category => (
                            category.nav[0].nav.map(section => {
                                ...
                                console.log(categoryTitle, section)
                                return (
                                    <section
                                        key={sectionTitle}
                                        id={generateUniqueId(categoryTitle, sectionTitle)}
                                        className='mb-12'
                                    >
                                        <h2 
                                          onClick={() => toggleSection(generateUniqueId(categoryTitle, sectionTitle))}
                                            ...
                                            <span className="flex items-center gap-2">
                                              <svg
                                                className={`w-4 h-4 transition-transform duration-200 
                                                  ${(expandedSections[generateUniqueId(categoryTitle, sectionTitle)] ?? true) ? 'rotate-90' : ''}`}
                                                viewBox="0 0 24 24"
                                              >
                                                <path
                                                  fill="currentColor"
                                        ...
                                        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4
                                          ...
                                          ${(expandedSections[generateUniqueId(categoryTitle, sectionTitle)] ?? true) 
