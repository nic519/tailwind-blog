import { getBodyFontSize } from './theme'
 ...
 * 添加节点边框（用于 neo 主题）
 */
export const addNodeBorders = (svgElement: SVGElement, resolvedTheme: string | undefined): void => {
 ...
 * 统一连接线风格（用于 neo 主题）
 */
export const styleEdges = (svgElement: SVGElement, resolvedTheme: string | undefined): void => {
  ...
  edges.forEach((edge) => {
    ...
    svgEdge.style.setProperty('shape-rendering', 'geometricPrecision', 'important')
