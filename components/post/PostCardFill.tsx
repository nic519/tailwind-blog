...
export default function PostCardFill({ post }: { post: Post }) {
      ...
      <Link href={`/blog/${slug}`} className="block">
        <div className="overflow-hidden relative h-[400px] w-full">
          {cover ? (
            ...
            <div
              className={`w-full h-full bg-[#45B39D]/50 dark:bg-[#45B39D]/30 relative flex items-start justify-center pt-8`}
            // style={{ 
          ...
          <div className="absolute top-[150px] left-0 right-0 p-6 z-10">
